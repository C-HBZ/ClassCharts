...
# the head noun. These are meta/format words that describe the homework medium rather
# than the task itself. Matching is case-insensitive. Add words as needed.
...
def _extract_homework_label(title: str) -> str:
    ...
    Rules applied in order:
      ...
      3. Strip any trailing noise/format words defined in HOMEWORK_TRAILING_NOISE
         (e.g. "Info", "Sheet", "Handout") — repeated until no more noise words remain.
